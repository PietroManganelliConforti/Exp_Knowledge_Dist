...
if __name__ == '__main__':
    ...
    from resnet_imagenet import resnet18 as r18

    net_list=[#resnet18(),
    resnet8(),  #layer3 - layer3.0.conv2
    r18(),  #layer4 - layer4.conv1.conv2
    resnet32x4(), #layer3 - layer3.4.conv2
    resnet110(),  #layer3 - layer3.17.conv2
    resnet110x2(), #layer3 - layer3.17.conv2
    resnet8x4(),  #layer3 - layer3. 0. conv 2 (prima del downsample)
    resnet32(),  #layer3 - layer3.4.conv2
    resnet44(), #layer3 - layer3.6.conv2
    resnet56(), #layer3 - layer3.8.conv2
    resnet116()]
